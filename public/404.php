...
<body class="bg-primaryC">
    ...
    <main>
        ...
        <section>
            <div class="container h-screen px-24 py-12">
                <div class="flex flex-wrap items-center justify-center w-10/12 mx-auto">
                    <div class="w-1/2">
                        <lottie-player src="./dist/imgs/data.json" background="transparent" speed="1" style="width: 500px; height: 500px;" loop autoplay></lottie-player>
                    </div>
                    <div class="flex flex-col items-center self-center justify-center w-1/2 text-center">
                        <h1 class="text-9xl font-futuraL text-textC">404</h1>
                        <h2 class="text-2xl font-futuraB text-textAltC">UH OH! You're lost.</h2>
                        <p class="mb-4 text-3xl font-futuraB text-textC">The page you are looking for does not exist.
                            How you got here is a mystery. But you can click the button below
                            to go back to the homepage.</p>
                        <a class="inline-flex px-10 py-3 text-lg border-2 rounded-full outline-none text-pureW bg-primaryC border-accentC hover:bg-accentC hover:text-textC" href="/">Home</a>
                    </div>
                </div>
            </div>
        </section>
